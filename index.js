...
async function askKaterDag() {
    ...
    await channel.send({ content: `Welke dag bestellen we takeaway deze week?`, components: [row] });
    ...
    collector.on('collect', async i => {
        ...
        await i.update({ content: `Mercikes om op ${i.label} te klikken ${i.user}`, components: newActionRows });
    });
}
